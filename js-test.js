// Другий слайдер
const deliveryTrack = document.querySelector('.slider-delivery');
const prevBtnDelivery = document.querySelector('.prev-btn');
const nextBtnDelivery = document.querySelector('.next-btn');
const deliverySlides = document.querySelectorAll('.slide-delivery');
